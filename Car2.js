        ...
        <>
            <group scale={3} position={[0, 1, 0]}>
                ...
                >
                    ...
                    <group>
                        ...
                        <mesh geometry={nodes.Cube004_2.geometry} material={materials['Материал']} castShadow
                              receiveShadow/>
                        <mesh geometry={nodes.Cube004_3.geometry} ref={leftR}  name={"left-r"} material={materials['Материал']} castShadow
                              receiveShadow/>
                        <mesh geometry={nodes.Cube004_4.geometry} ref={rightR} name={"right-r"} material={materials['Материал']} castShadow
                              receiveShadow/>
                ...
                <RigidBody type={"dynamic"} colliders={"hull"} friction={props.friction} ref={front_right_wheel}>
                    <mesh position={[0.74, 0, 0]} geometry={nodes.front_right_wheel.geometry}
                          material={materials['Материал.001']} castShadow receiveShadow/>

                </RigidBody>
                <RigidBody type={"dynamic"} colliders={"hull"} friction={props.friction} ref={front_left_wheel}>
                    <mesh position={[-0.68, 0, 0]} geometry={nodes.front_left_wheel.geometry}
                          material={materials['Материал.001']} castShadow receiveShadow/>
                </RigidBody>
